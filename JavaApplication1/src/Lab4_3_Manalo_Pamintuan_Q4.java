 ...
 * @author Bryan
 */
public class Lab4_3_Manalo_Pamintuan_Q4 extends javax.swing.JFrame {
    ...
    public Lab4_3_Manalo_Pamintuan_Q4(int questionAnswered,int marks) {
        initComponents();
        setTitle("Minecraft Quiz Question 4");
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Which hostile mob is known for exploding when it gets close to the player?");

        btnGroup1.add(jrbtn1);
        jrbtn1.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jrbtn1.setText("Zombie");
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        if(!jrbtn1.isSelected() && !jrbtn2.isSelected() && !jrbtn3.isSelected() ){
            ...
            new Lab4_3_Manalo_Pamintuan_Q5(quizanswerd, marks).setVisible(true);
            this.dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Lab4_3_Manalo_Pamintuan_Q4(0,0).setVisible(true);
            }
        });
    }
