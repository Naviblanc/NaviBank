...
import javaapplication1.Results;
 ...
 * @author Bryan
 */
public class Lab4_3_Manalo_Pamintuan_Q5 extends javax.swing.JFrame {
    ...
    public Lab4_3_Manalo_Pamintuan_Q5(int questionAnswered,int marks) {
        initComponents();
        setTitle("Minecraft Quiz Question 5");
    ...
    private void initComponents() {
        ...
        jLabel3.setText("What is the name of the pixelated, cube-shaped world in minecraft");

        btnGroup1.add(jrbtn1);
        jrbtn1.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jrbtn1.setText("Pixeland");
        ...
        jrbtn3.setText("Minecraft World");
        ...
        btnSubmit.setText("Submit and View Score!");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(225, 225, 225)
                        .addComponent(btnSubmit, javax.swing.GroupLayout.PREFERRED_SIZE, 249, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        if(!jrbtn1.isSelected() && !jrbtn2.isSelected() && !jrbtn3.isSelected() ){
            ...
            new Results(quizanswerd, marks).setVisible(true);
            this.dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Lab4_3_Manalo_Pamintuan_Q5(0,0).setVisible(true);
            }
        });
    }
