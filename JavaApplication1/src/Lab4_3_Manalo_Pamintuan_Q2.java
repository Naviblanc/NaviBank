 ...
 * @author Bryan
 */
public class Lab4_3_Manalo_Pamintuan_Q2 extends javax.swing.JFrame {
    ...
    public Lab4_3_Manalo_Pamintuan_Q2(int questionAnswered,int marks) {
        initComponents();
        setTitle("Minecraft Quiz Question 2");
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Which dimension is known for its Nether Fortresses and Blaze enemies?");

        btnGroup1.add(jrbtn1);
        jrbtn1.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jrbtn1.setText("The End");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(jrbtn2, javax.swing.GroupLayout.PREFERRED_SIZE, 132, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(150, 150, 150)
                .addComponent(jrbtn3)
                .addGap(66, 66, 66))
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        if(!jrbtn1.isSelected() && !jrbtn2.isSelected() && !jrbtn3.isSelected() ){
            ...
            new Lab4_3_Manalo_Pamintuan_Q3(quizanswerd, marks).setVisible(true);
            this.dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Lab4_3_Manalo_Pamintuan_Q2(0,0).setVisible(true);
            }
        });
    }
