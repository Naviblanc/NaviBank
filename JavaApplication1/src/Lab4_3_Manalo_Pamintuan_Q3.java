 ...
 * @author Bryan
 */
public class Lab4_3_Manalo_Pamintuan_Q3 extends javax.swing.JFrame {
    ...
    public Lab4_3_Manalo_Pamintuan_Q3(int questionAnswered,int marks) {
        initComponents();
        setTitle("Minecraft Quiz Question 3");
    ...
    private void initComponents() {
        ...
        jLabel3.setText("What is the name of the block that players use to craft items in Minecraft?");

        btnGroup1.add(jrbtn1);
        jrbtn1.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jrbtn1.setText("Crafting Table");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                .addGap(28, 28, 28)
                .addComponent(jrbtn1, javax.swing.GroupLayout.PREFERRED_SIZE, 131, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        if(!jrbtn1.isSelected() && !jrbtn2.isSelected() && !jrbtn3.isSelected() ){
            ...
            new Lab4_3_Manalo_Pamintuan_Q4(quizanswerd, marks).setVisible(true);
            this.dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Lab4_3_Manalo_Pamintuan_Q3(0,0).setVisible(true);
            }
        });
    }
